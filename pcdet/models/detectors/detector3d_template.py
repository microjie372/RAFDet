...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            'vfe', 'backbone_2d', 'map_to_bev_module', 'pfe',
            'backbone_3d', 'dense_head', 'point_head', 'roi_head'
        ]
    ...
    def build_backbone_2d(self, model_info_dict):
        ...
        backbone_2d_module = backbones_2d.__all__[self.model_cfg.BACKBONE_2D.NAME](
            in_channels=self.model_cfg.BACKBONE_2D.INPUT_CHANNELS,
            out_channels=self.model_cfg.BACKBONE_2D.OUTPUT_CHANNELS,
            kernel_cfg=self.model_cfg.BACKBONE_2D.get('KERNEL_CFG', None)
        )
    ...
    # def post_processing(self, batch_dict):               #origin codes
    #     """
    #     Args:
    #         batch_dict:
    #             batch_size:
