...
Currently we provide the dataloader of KITTI dataset, DAIR-V2X dataset and Waymo dataset.
...
* Generate the data infos by running the following command: 
```python 
python -m pcdet.datasets.dair_v2x_kitti.kitti_dataset create_kitti_infos tools/cfgs/dataset_configs/dair_v2x_kitti_dataset.yaml
```
